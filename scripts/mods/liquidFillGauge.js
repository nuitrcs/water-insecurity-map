...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    if(config.valueCountUp){
        var textTween = function(){
            progress =0.0
            var i = d3.interpolate(progress, value/100); 
            return function(t) {  
                progress = i(t); 
                text1.text(formatPercent1(progress*100)+"%"); }
        }

        var textTween11 = function(){
            progress =0.0
            var i = d3.interpolate(progress, value/100); 
            return function(t) {  
                progress = i(t); 
                text2.text(formatPercent1(progress*100)+"%"); }
        };
